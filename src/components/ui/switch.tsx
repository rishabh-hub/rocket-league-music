...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        'pointer-events-none block size-4 rounded-full bg-foreground shadow-[0_1px_2px_0_hsl(var(--overlay)/0.5)] ring-0 transition-transform duration-fast ease-overshoot data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0'
      )}
    />
  </SwitchPrimitives.Root>
));
